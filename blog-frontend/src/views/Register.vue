    ...
    <div class="auth-card">
      ...
      <div class="card-right">
        ...
        <el-form :model="form" @submit.prevent="handleRegister" class="auth-form">
          ...
          <div class="input-wrapper">
            <span class="input-icon">🔒</span>
            <input v-model="form.password" type="password" placeholder="密码（至少6位）" class="styled-input" />
          </div>
          <div class="input-wrapper">
            <span class="input-icon">🔒</span>
            <input v-model="form.confirmPassword" type="password" placeholder="确认密码" class="styled-input" @keyup.enter="handleRegister" />
          </div>
